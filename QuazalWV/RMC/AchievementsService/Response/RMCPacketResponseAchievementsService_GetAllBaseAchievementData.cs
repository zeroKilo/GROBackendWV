...
namespace QuazalWV
{
    public class RMCPacketResponseAchievementsService_GetAllBaseAchievementData : RMCPResponse
    {
        ...
        public RMCPacketResponseAchievementsService_GetAllBaseAchievementData()
        {
        ...
        {
            return "[RMCPacketResponseAchievementsService_GetAllBaseAchievementData]";
        }
